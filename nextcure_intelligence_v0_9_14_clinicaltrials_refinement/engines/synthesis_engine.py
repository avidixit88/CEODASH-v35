...
def build_synthesis_summary(
    ...
    **_ignored_future_inputs: object,
    ...
    interpretation_brief = [
        ...
        "v0.9.3 adds NextCure-specific relevance scoring so incoming information is filtered against NextCure targets, modalities, side channels, and value drivers before it reaches the executive layer.",
    ]
